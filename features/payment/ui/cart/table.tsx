      ...
      <table className="table-fixed w-full">
        <thead className="border-b mb-4">
          <tr className="text-neutral-500">
            <th className="py-3 px-2 text-sm font-medium text-start w-[312px]">
              Producto
            </th>
            <th className="py-3 px-2 text-sm font-medium text-center">Precio</th>
            <th className="py-3 px-2 text-sm font-medium text-center">Cantidad</th>
            <th className="py-3 px-2 text-sm font-medium text-center">Subtotal</th>
            <th className="py-3 px-2 text-sm font-medium text-center"></th>
          </tr>
        </thead>
        <tbody>
          <tr>
