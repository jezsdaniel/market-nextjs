  ...
  return (
    <div className="flex flex-col md:flex-row md:items-end px-6 py-10 md:space-x-24 lg:space-x-32">
      ...
      <div className="flex flex-col mt-10 md:mt-0">
        <div className="text-3xl font-bold">Contáctanos</div>
        <div className="text-sm text-neutral-600 font-medium mt-6">
        ...
        <div className="flex flex-row items-center mt-4">
          ...
          <div className="text-amber font-semibold ml-2">(+1) 800 435 234</div>
        </div>
        <div className="flex flex-row items-center mt-4">
          <UilEnvelope size={24} className="fill-amber" />
          <div className="text-amber font-semibold ml-2">fress@gmail.com</div>
        </div>
        <div className="text-sm text-neutral-600 font-medium mt-6">
